...
//       // 你想对他发送的模板消息的模板ID
//       useTemplateId: "8NdttM9hIoe79fAnm3EALGNxPbqokGuZqltWihSKX4E",
//       // 所在省份
//       province: "新疆",
//       // 所在城市
//       city: "塔城",
...
//     },
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "RaCEhh4gCRQ-snTAZzUU6yZvirEG4uVJ4YhfA6exkBg",
      // 所在省份
      province: "上海",
      // 所在城市
      city: "上海",
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {"type": "*生日", "name": "自己", "year": "1994", "date": "12-04"}
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 在一起的日子
